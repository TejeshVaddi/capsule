import { db, refreshDataMode } from "./data.js?v=611e55e30f";
import { onAuthChange } from "./cloud.js?v=611e55e30f";
import { cloudConfigured } from "./config.js?v=611e55e30f";
import { revokePhotoUrls } from "./ui.js?v=611e55e30f";
import { ICONS, LOGO_SVG } from "./icons.js?v=611e55e30f";
import { renderHomeView } from "./views/home.js?v=611e55e30f";
import { renderJournalView } from "./views/journal.js?v=611e55e30f";
import { playIntro } from "./intro.js?v=611e55e30f";
import { getStreak } from "./daily.js?v=611e55e30f";
import { renderRecallView } from "./views/recall.js?v=611e55e30f";
import { renderActivitiesView } from "./views/activities.js?v=611e55e30f";
import { renderTrendsView } from "./views/trends.js?v=611e55e30f";
import { renderHistoryView } from "./views/history.js?v=611e55e30f";
import { renderAccountView, openDeleteFlow } from "./views/account.js?v=611e55e30f";
import { renderFooter } from "./footer.js?v=611e55e30f";
import { isCloudMode } from "./data.js?v=611e55e30f";
import { destroyCharts } from "./charts.js?v=611e55e30f";
import { shouldShowWalkthrough, startWalkthrough } from "./walkthrough.js?v=611e55e30f";
import { openPrivacyPolicy, POLICY_VERSION } from "./privacy.js?v=611e55e30f";
import { openTerms, TERMS_VERSION } from "./terms.js?v=611e55e30f";
import { migrateMetrics } from "./migrate.js?v=611e55e30f";
